                    ...
                    <div className="flex justify-center min-h-screen fixed">
                        <div className="flex flex-col justify-center">
                            <div className="flex justify-center border-b-[1.5px] border-gray-500/20">
                                <h1 className="font-bold text-2xl pb-3">{shoeData.name}</h1>
                            </div>
                                                            ...
                                                            {isAvailable ? (
                                                                ...
                                                                <>
                                                                    <div className="relative">
                                                                        <button disabled className="text-lg w-14 h-14 rounded-lg border-2 border-gray-500/20 text-gray-500/20 relative">
                                                                            {size}
                                                                        </button>
                                                                        {!isAvailable && (
